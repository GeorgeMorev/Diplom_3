...
class TestOrderFeed:
    ...
    def test_today_done_counter_increases(self, driver, login_user, request, open_page):
        feed_page = open_page(FeedPage)
    ...
    def test_new_order_appears_in_progress(self, driver, login_user, create_order, open_page):
        feed_page = open_page(FeedPage)
